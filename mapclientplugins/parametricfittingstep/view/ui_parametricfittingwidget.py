...
class Ui_ParametricFittingWidget(object):
    def setupUi(self, ParametricFittingWidget):
        ...
        self.gridLayout_3.addWidget(self.fittingRigid_label, 3, 0, 1, 1)
        ...
        self.frame_2 = QtGui.QFrame(self.fitting_groupBox)
        self.frame_2.setFrameShape(QtGui.QFrame.StyledPanel)
        self.frame_2.setFrameShadow(QtGui.QFrame.Raised)
        self.frame_2.setObjectName("frame_2")
        self.gridLayout_2 = QtGui.QGridLayout(self.frame_2)
        self.gridLayout_2.setObjectName("gridLayout_2")
        self.fittingZAxis_pushButton = QtGui.QPushButton(self.frame_2)
        self.fittingZAxis_pushButton.setText("")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/parametricfitting/images/axis_roation_z_axis_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.fittingZAxis_pushButton.setIcon(icon)
        self.fittingZAxis_pushButton.setObjectName("fittingZAxis_pushButton")
        self.gridLayout_2.addWidget(self.fittingZAxis_pushButton, 0, 4, 1, 1)
        self.fittingXAxis_pushButton = QtGui.QPushButton(self.frame_2)
        self.fittingXAxis_pushButton.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/parametricfitting/images/axis_roation_x_axis_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.fittingXAxis_pushButton.setIcon(icon1)
        self.fittingXAxis_pushButton.setObjectName("fittingXAxis_pushButton")
        self.gridLayout_2.addWidget(self.fittingXAxis_pushButton, 0, 2, 1, 1)
        self.fittingYAxis_pushButton = QtGui.QPushButton(self.frame_2)
        self.fittingYAxis_pushButton.setText("")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/parametricfitting/images/axis_roation_y_axis_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.fittingYAxis_pushButton.setIcon(icon2)
