...
# Form implementation generated from reading ui file 'meshgeneratorwidget_fitting.ui'
#
# Created: Mon Sep  3 12:25:02 2018
...
class Ui_MeshGeneratorWidget(object):
    def setupUi(self, MeshGeneratorWidget):
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 417, 1060))
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.deleteElementsRanges_lineEdit.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.scale_lineEdit.sizePolicy().hasHeightForWidth())
        ...
        self.fiducialMarkers_groupBox_2 = QtGui.QGroupBox(self.scrollAreaWidgetContents_2)
        self.fiducialMarkers_groupBox_2.setObjectName("fiducialMarkers_groupBox_2")
        ...
        self.fiducialMarkerTransform_pushButton_3 = QtGui.QPushButton(self.fiducialMarkers_groupBox_2)
        self.fiducialMarkerTransform_pushButton_3.setObjectName("fiducialMarkerTransform_pushButton_3")
        self.gridLayout_5.addWidget(self.fiducialMarkerTransform_pushButton_3, 1, 1, 1, 1)
        self.fiducialMarkerTransform_pushButton_2 = QtGui.QPushButton(self.fiducialMarkers_groupBox_2)
        self.fiducialMarkerTransform_pushButton_2.setObjectName("fiducialMarkerTransform_pushButton_2")
        self.gridLayout_5.addWidget(self.fiducialMarkerTransform_pushButton_2, 1, 0, 1, 1)
    ...
    def retranslateUi(self, MeshGeneratorWidget):
        ...
        self.fiducialMarkers_groupBox_2.setTitle(QtGui.QApplication.translate("MeshGeneratorWidget", "Fitting", None, QtGui.QApplication.UnicodeUTF8))
        self.fiducialMarkerTransform_pushButton_3.setText(QtGui.QApplication.translate("MeshGeneratorWidget", "Non-Rigid Fitting", None, QtGui.QApplication.UnicodeUTF8))
        self.fiducialMarkerTransform_pushButton_2.setText(QtGui.QApplication.translate("MeshGeneratorWidget", "Rigid Fitting", None, QtGui.QApplication.UnicodeUTF8))
